...
namespace EntidadesInstanciables
{
    public class GestorSql
    {
        ...
        public void ConfigurarDataAdapter()
        {
            ...
            this.da.InsertCommand = new SqlCommand("INSERT INTO FabricaTPFinal (marca, modelo, precio, tipo) VALUES (@marca, @modelo, @precio, @tipo)", cn);
            this.da.UpdateCommand = new SqlCommand("UPDATE FabricaTPFinal SET marca=@marca, modelo=@modelo, precio=@precio, tipo=@tipo WHERE id=@id", cn);
